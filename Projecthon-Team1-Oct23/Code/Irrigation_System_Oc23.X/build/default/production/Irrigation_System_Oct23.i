...
# 7 "Irrigation_System_Oct23.c" 2

# 1 "./PICSim_Manual_Add_Files\\Lcd\\LCD_4Bit.h" 1
# 23 "./PICSim_Manual_Add_Files\\Lcd\\LCD_4Bit.h"
...
# 8 "Irrigation_System_Oct23.c" 2
# 18 "Irrigation_System_Oct23.c"
char lcd_buff[20];
...
unsigned int read_moisture(void)
{
    ...
    read_moist = 0;
    read_moist = ADCC_GetSingleConversion(0);
...
unsigned int read_temperature(void)
{
    ...
    read_temp_adc_count = ADCC_GetSingleConversion(1);
