...
# 2 "<built-in>" 2
# 1 "Irrigation_System.c" 2
# 44 "Irrigation_System.c"
...
void main(void)
{
    ...
    SYSTEM_Initialize();
    lcd_4bit_init();
# 69 "Irrigation_System.c"
    lcd_1st_line(0);
    lcd_puts("EmbedDNA");
    lcd_2nd_line(0);
    lcd_puts("Irrigation System Project");
    while (1)
    {
